...
class ChatSessionsCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => WebRtcConnectionsCreateNestedManyWithoutChatSessionsItemsInput,
  })
  @ValidateNested()
  @Type(() => WebRtcConnectionsCreateNestedManyWithoutChatSessionsItemsInput)
  @IsOptional()
  @Field(() => WebRtcConnectionsCreateNestedManyWithoutChatSessionsItemsInput, {
    nullable: true,
  })
  webRtcConnectionsItems?: WebRtcConnectionsCreateNestedManyWithoutChatSessionsItemsInput;
}

export { ChatSessionsCreateInput as ChatSessionsCreateInput };
