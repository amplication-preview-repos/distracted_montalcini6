...
@InputType()
class WebRtcConnectionsCreateNestedManyWithoutUsersInput {
...
export { WebRtcConnectionsCreateNestedManyWithoutUsersInput as WebRtcConnectionsCreateNestedManyWithoutUsersInput };
